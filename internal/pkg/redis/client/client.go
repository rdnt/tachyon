...
import (
	...
	redisevent "github.com/rdnt/tachyon/internal/pkg/redis/client/event"
)
...
func New(client *redis.Client, streamKey string) *Client {
	return &Client{
		client:    client,
		streamKey: streamKey,
	}
...
func (r *Client) Publish(e event.Event) error {
...
func (r *Client) Subscribe(handler func(event2 event.Event)) (func(), error) {
...
func (r *Client) Events() ([]event.Event, error) {
